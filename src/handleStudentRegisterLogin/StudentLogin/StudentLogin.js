        ...
        <div className="student-login-container">
            ...
            <form className="login-form" onSubmit={handleSubmit}>
                <div className="form-group">
                    ...
                    <input className="pt-serif-regular  lg-std-inp" type="email" id="email" name="email" value={userDetails.email} onChange={handleChange} required/>
                </div>
                <div className="form-group">
                    <label htmlFor="password">Password:</label>
                    <div className='password-container'>
                    <input className="pt-serif-regular lg-std-inp" type={`${isPasswordVisible? 'text' : 'password'}`} id="password" name="password" value={userDetails.password} onChange={handleChange} required/>
                    {
