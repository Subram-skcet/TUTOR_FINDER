...
const Main = () => {
  ...
  return (
    ...
    <div className="container">
      <h1 className='filter-tit-h1'>Filter</h1>
      <div className="search-bar">
        <div>
          <label className='main-label'>Search By Name:</label>
          <input type="text" name="name" value={searchDetails.name} className='main-input' onChange={handleChange} />
        </div>
        <div>
          <label>Search By Subject:</label>
          <input type="text" name="subject" value={searchDetails.subject} className='main-input' onChange={handleChange} />
        </div>
        <div>
          <label>Search By Board:</label>
          <select name="boards" onChange={handleChange} className='main-select'>
        ...
        <div>
          ...
          <select name="state" id="inputState" value={searchDetails.state} className='main-select' onChange={handleStateChange}>
        ...
        <div>
          ...
          <select name="district" id="inputDistrict" value={searchDetails.district} className='main-select' onChange={handleChange} disabled={!searchDetails.state}>
        ...
        <div>
          ...
          <select value={searchDetails.std} name="std" onChange={handleChange} className='main-select'>
      ...
      <div className="search-results">
        ...
        <div className="tutor-card">
            <div className="profile-pic">
              <img src="https://images.pexels.com/photos/14653174/pexels-photo-14653174.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Profile" />
            </div>
